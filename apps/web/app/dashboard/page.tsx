  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        const stats: CampaignStats[] = data.map((c) => ({
          ...c,
          ...
          >
            ...
            <div className="mt-3 h-0.5 w-full bg-white/5 rounded-full">
              <div
                ...
                style={{ width: `${Math.min(qualityPct || 30, 100)}%` }}
              />
            </div>
          </div>
        ))}
        ...
        <div className="lg:col-span-2 rounded-xl bg-white/[0.02] border border-white/[0.06] overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.06]">
            ...
            <Link
              ...
              className="text-[#f05a28] text-[11px] font-bold hover:underline"
            >
              View All
            </Link>
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-white/[0.05]">
                  <th className="px-5 py-3 text-[10px] font-black uppercase tracking-widest text-white/30">
                    Campaign Name
                  </th>
                  <th className="px-4 py-3 text-[10px] font-black uppercase tracking-widest text-white/30">
                    Source
                  </th>
                  <th className="px-4 py-3 text-[10px] font-black uppercase tracking-widest text-white/30">
                    Target
          ...
          <div className="p-4 space-y-3 flex-1 overflow-y-auto">
            {loading ? (
              ...
              <p className="text-white/30 text-sm text-center pt-8">
                Create campaigns to see insights.
              </p>
            ) : (
              <>
        ...
        <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-5">
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-3 text-[10px] font-bold text-white/40 uppercase tracking-widest">
              ...
              <span className="flex items-center gap-1">
                <span className="h-2 w-2 rounded-full bg-[#f05a28] inline-block" />
                Generated
              </span>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="h-1 bg-white/5 rounded-full">
                  <div
                    ...
                    style={{ width: `${Math.min(100 - qualityPct, 100)}%` }}
                  />
                </div>
              </div>
            </div>
