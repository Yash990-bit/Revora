  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white font-syne text-glow">Protocol Settings</h1>
          <p className="text-sm text-gray-400 mt-1">Configure your autonomous environment variables.</p>
        </div>
        ...
        <div className="flex-1 p-8 rounded-[40px] bg-white/[0.01] border border-white/[0.05] backdrop-blur-3xl relative overflow-hidden group">
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-right-2 duration-500 relative z-10">
              <div className="bg-[#5B6EFF]/5 p-6 rounded-3xl border border-[#5B6EFF]/20 flex items-center gap-5">
                 ...
                 <div>
                    ...
                    <p className="text-sm text-gray-500 font-medium mt-1 uppercase tracking-tight">Main Cluster Admin</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-[#5B6EFF] ml-1">Display Name</label>
                  <input 
                    type="text" 
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-[#5B6EFF] ml-1">Autonomous Signature</label>
                <textarea 
                  rows={4}
          ...
          {activeTab !== "account" && (
            <div className="flex flex-col items-center justify-center py-20 text-center animate-in zoom-in-95 duration-500 relative z-10">
               ...
               <h3 className="text-xl font-bold text-white uppercase tracking-tighter">Locked Module</h3>
               <p className="text-sm text-gray-500 mt-2 max-w-xs">{activeTab} configuration is restricted to production-ready workspace nodes.</p>
