    ...
    <section ref={sectionRef} className={s.section}>
      ...
      <div className={s.header}>
        ...
        <div className={s.subRow}>
          ...
          <p className={s.subDesc}>Spend less time guessing and more time building.</p>
        </div>
      </div>
        ...
        <div className={s.rightCol}>
          ...
          <div className={s.ctaBox}>
            ...
            <p className={s.ctaDesc}>
              Every team&apos;s needs are different. Let our experts show you how AutoPilot SDR can
              work for your specific requirements — let&apos;s have a chat and find the right
              solution for you.
            </p>
